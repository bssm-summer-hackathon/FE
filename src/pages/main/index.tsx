      ...
      <Container>
        ...
        <Subpage>  
          ...
          <TextBox style={{marginLeft: "150px", marginTop: ""}}>
            ...
            <SubText>
              오늘 하루를 일기로 기록하면,<br/>
              AI가 한 장의 그림으로 표현해 줘요.<br/><br/>
              AI와 함께 오늘 느꼈던 감정들을 그림 일기로 표현해 보아요 :)
            </SubText>
          </TextBox>
          <TextBox style={{textAlign: 'end', marginLeft: 'auto', marginRight: '150px'}}>
              <div style={{display: 'flex', justifyContent:'flex-end'}}>
                <MainText>나만의 일기 갤러리</MainText>
                <Icon src="/images/landing/image.svg" alt="" />
             </div>
            <SubText>
              기록했던 일기들은 갤러리에서 다시 볼 수 있어요!<br/>
              나만의 그림 일기 갤러리를 쌓아 보세요.<br/><br/>
          ...
          <TextBox  style={{marginLeft: "150px"}}>
            ...
            <SubText>
              고민이나 걱정되는 일이 있었나요?<br/>
              AI와의 대화를 통해 조언을 얻을 수 있어요.<br/><br/>
